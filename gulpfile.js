...
gulp.task(
  ...
  (task.html = function() {
    return gulp
      .src(joinPath(paths.templates, "**/*.tpl.html"))
...
gulp.task(
  "deletelanguagemenuitem",
  (task.deletelanguagemenuitem = function() {
    var german = gulp
      .src(joinPath(paths.dist, "de/**/*.html"))
      .pipe(
        deleteLines({
          filters: [/>DEU<\/a><\/li>/i]
        })
    ...
    var italian = gulp
      .src(joinPath(paths.dist, "it/**/*.html"))
      .pipe(
        deleteLines({
          filters: [/>ITA<\/a><\/li>/i]
        })
...
gulp.task(
  "pages",
  (task.pages = gulp.series("html", "deletelanguagemenuitem"))
);
...
gulp.task("watch", function() {
  ...
  gulp.watch(joinPath(paths.languages, "**/*.yaml"), gulp.series("pages"));
